...
function Rellenar_clases_inscripcion_vacio() {
	...
	html += "<li rel='0' class='add'>ADD CLASS<div rel='0' id='img-add-class1' class='div-action-add-class icon-list-right icon-add-class'></div></li>";
	html += "</ul>";
...
function Rellenar_clases_inscripcion(data) {
	...
	if (data.length>0) {
		for (var i = 0; i < data.length; i++) {
			...
			html += "<div rel='" + data[i].id + "' id='img-remove-class' class='div-action-class icon-list-right icon-remove-class'></div></li>"; 
		}
		Lungo.Element.count("#label-inscrip-classes", data.length);
		html += "<li rel='0' class='add'>ADD CLASS<div rel='0' id='img-add-class2' class='div-action-add-class icon-list-right icon-add-class'></div></li>";
	}
	html += "</ul>";
	$$("#content-my-inscrip-classes").html(html);
}
...
function Rellenar_servicios_inscripcion(data) {
	...
	html += "<li rel='0' class='add'>ADD SERVICE/PRODUCT<div rel='0' id='img-add-service1' class='div-action-add-class icon-list-right icon-add-class'></div></li>";
	if (data.length>0) {
		for (var i = 0; i < data.length; i++) {
			if (i%2==0) {
				class_alter = " class='par' ";
			...
			html += "<div rel='" + data[i].id + "' id='img-remove-service' class='div-action-class icon-list-right icon-remove-class'></div></li>"; 
		}
		Lungo.Element.count("#label-inscrip-services", data.length);
		html += "<li rel='0' class='add'>ADD SERVICE/PRODUCT<div rel='0' id='img-add-service2' class='div-action-add-class icon-list-right icon-add-class'></div></li>";
	}
	html += "</ul>";
	$$("#content-my-inscrip-services").html(html);
}

function Rellenar_servicios_inscripcion_vacia() {
	$$("#content-my-inscrip-services").html("");
	var html = "<ul id='list-services' class='list'>";
	html += "<li rel='0' class='add'>ADD SERVICE/PRODUCT<div rel='0' id='img-add-class1' class='div-action-add-class icon-list-right icon-add-class'></div></li>";
	html += "</ul>";
...
function Rellenar_totales_inscripcion(data) {
	...
	html += "<tr><td class='td1-summary'>NET:</td><td class='td2-summary'>" + app_moneda + " " + number_format(data.total,2) + "</td></tr>";
	html += "<tr><td class='td1-summary'>HM Fee:</td><td class='td2-summary'>" + app_moneda + " " + number_format(data.total_hm,2) + "</td></tr>";
	html += "<tr><td class='td1-summary'>VAT:</td><td class='td2-summary'>" + app_moneda + " " + number_format(data.total_vat,2) + "</td></tr>";
	html += "<tr><td class='td1-summary'>Paypal Fee:</td><td class='td2-summary'>" + app_moneda + " " + number_format(data.total_paypal,2) + "</td></tr>";
	html += "<tr><td colspan='2'><div class='divisor-class'></div></td></tr>";
	html += "<tr><td class='td1-summary font120 bold700'>Total Payment:</td><td class='td2-summary font120 bold700'>" + app_moneda + " " + number_format(total_final,2) + "</td></tr>";
	html += "</table>";
	...
	if (total_final>0) {
		...
		if (data.req_tc_special && data.tc_special.length>0) {
			html2 += "<fieldset><label class='anchor width70'>I accept these <a href='javascript:Ver_doc(\"Special T&C\", \"" + nl2br(data.tc_special) + "\");' class='underline'>" + 
				"Event Special T&C</a></label><input type='checkbox' id='chk_special' name='chk_special' class='inline right' /></fieldset>";		
		}
		if (!data.mayor_edad) {
...
function Rellenar_totales_inscripcion_vacia(evento) {
	...
	var html = "<table class='width100 font110 line180'>";
	html += "<tr><td class='td1-summary'>NET:</td><td class='td2-summary'>" + app_moneda + " " + number_format(0,2) + "</td></tr>";
	html += "<tr><td class='td1-summary'>HM Fee:</td><td class='td2-summary'>" + app_moneda + " " + number_format(0,2) + "</td></tr>";
	html += "<tr><td class='td1-summary'>VAT:</td><td class='td2-summary'>" + app_moneda + " " + number_format(0,2) + "</td></tr>";
	html += "<tr><td class='td1-summary'>Paypal Fee:</td><td class='td2-summary'>" + app_moneda + " " + number_format(0,2) + "</td></tr>";
	html += "<tr><td colspan='2'><div class='divisor-class'></div></td></tr>";
	html += "<tr><td class='td1-summary font120 bold700'>Total Payment:</td><td class='td2-summary font120 bold700'>" + app_moneda + " " + number_format(0,2) + "</td></tr>";
	html += "</table>";
	var html2 = "<span class='font80 color-gris'>* V.A.T. only be applicable to HM Fee.</span><br><br>";
	$$("#summary-content").html(html);
	$$("#summary-content2").html(html2);
